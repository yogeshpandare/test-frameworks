...
public class ForumDAOImpl implements ForumDAO {
	...
	public void insertForum(Forum forum) {
		String query = "INSERT INTO FORUMS_1 (FORUM_ID, FORUM_NAME, FORUM_DESC) VALUES (:forumId,:forumName,:forumDesc)";
	...
	public Forum selectForum(int forumId) {
		String query = "SELECT * FROM FORUMS_1 WHERE FORUM_ID=:forumId";
		SqlParameterSource namedParameters = new MapSqlParameterSource(
				"forumId", Integer.valueOf(forumId));
